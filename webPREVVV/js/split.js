...
var hFinal='</br><p style="color:red;">RESULTS</br>Copy and paste separated  coordinates  back to  your  spreadsheet.Dont forget to  place focus on the  first cell before pasting </p> <input type="button" value="copy to  clipboard" id="copybutton"><span id="flashMessage"></span> </br></br><table id="tableResults" style="border:none" cellspacing="0" cellpadding="0">';
var dataX=''; var n;
