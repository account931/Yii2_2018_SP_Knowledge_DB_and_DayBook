...
//----------------------------------------------------
//Click SPLIT  Button
    $("#splitButtonG").click(function(){        // $(document).on("click", '.circle', function() {   // this  click  is  used  to   react  to  newly generated cicles;
...
//Click Instruction  Button
    $("#instructionButtonG").click(function(){
    $("#hiddenInstructions").toggle(1000);
if( $("#instructionButtonG").attr("value")=="instructions")
   { $("#instructionButtonG").val("Close");$("#instructionButtonG").css("background","red");} else { $("#instructionButtonG").val("instructions");$("#instructionButtonG").css("background","grey")}
