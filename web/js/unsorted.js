...
//                                                                                     ** 
 ...
 $("#wToG_sort").click(function(){
 
 
 //check if  not  empty
    if($('#col1').val()=='' || $('#col2').val()=='' ){
                            $("#resultFinal_sort").stop().fadeOut("slow",function(){  $(this).html("<h1 style='color:red;'>ERROR-> check  your  input-it is  empty</h1>") }).fadeIn(2000);
                            $("#resultFinal_sort").css("border","1px solid red"); //  set  red  border  for  result  div
							return  false; }
...
//var Wvalue=$('#Wvalue').val();
      ...
      var textAreaArray2=textareaX2.split('\n');  alert('arr1-> '+textAreaArray1.length  + ' , arr2-> '+textAreaArray2.length);
...
var dataX=''; var n; //??
	 ...
	 //End ReIndexOf-----------------------------------------------------------
	  ...
	  //  HTML  results
	  $("#resultFinal_sort").stop().fadeOut("slow",function(){ 
                $(this).html(hFinal)
            }).fadeIn(2000);
